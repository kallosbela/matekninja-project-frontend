...
const Statistics = () => {
  ...
  return (
    <div>
      ...
      <DateInput setStatistics={setStatistics} />
      {statistics && statistics==="No statistics found" && <Text fontSize={"xl"} textAlign="center">Nincs statisztika az adott időszakban</Text>}
